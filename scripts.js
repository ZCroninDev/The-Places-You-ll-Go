function MouseRolloverOne(ramona_winter) {
    ramona_winter.src = "./assets/ramona_winter.png";
  }
function MouseOutOne(ramona_spring) {
    ramona_spring.src = "./assets/ramona_spring.png";
  }
function MouseRolloverTwo(lolopass_oregon) {
    lolopass_oregon.src = "./assets/lolopass_oregon.png";
  }
function MouseOutTwo(mcneilpoint_oregon) {
    mcneilpoint_oregon.src = "./assets/mcneilpoint_oregon.png";
  }
function MouseRolloverThree(zionpark_utah) {
  zionpark_utah.src = "./assets/zionpark_utah.png";
  }
function MouseOutThree(thenarrows_utah) {
  thenarrows_utah.src = "./assets/thenarrows_utah.png";
  }  
function MouseRolloverFour(yosemite_fall) {
  yosemite_fall.src = "./assets/yosemite_fall.png";
  }
